...
static int octaram_exec_op(xspidevice_ctrl_t *ctrl, xspi_op_t const *op,
			   bool is_write);
...
static int octaram_read(xspidevice_ctrl_t *ctrl, void *buffer, size_t address,
			size_t length);
static int octaram_write(xspidevice_ctrl_t *ctrl, void const *buffer,
			 size_t address, size_t length);
static int octaram_erase(xspidevice_ctrl_t *ctrl, size_t address,
			 size_t length);
static enum xspidevice_write_status
octaram_get_write_status(xspidevice_ctrl_t *ctrl);
...
/* Write Mode Register */
static const xspi_op_t op_write_mode = { .form = SPI_FORM_8_8_8,
					 .op = 0x4000,
					 .op_size = 2,
					 .op_is_ddr = true,
					 .address = 0x00040000,
...
static const xspi_op_t wop = { .form = SPI_FORM_8_8_8,
			       .op = 0x0000,
			       .op_size = 2,
			       .op_is_ddr = true,
			       .address = 0,
...
static int octaram_write_mode_register(octaram_apsxx_ctrl_t *myctrl,
				       uint16_t data)
{
