...
static const CPG_SETUP_DATA early_setup_tbl[] = {
	{ (uintptr_t)CPG_CLKON_SYC, (uintptr_t)CPG_CLKMON_SYC, 0x00010001,
	  CPG_T_CLK },
...
static CPG_SETUP_DATA cpg_clk_on_tbl[] = {
	{ /* CM33 */
	  (uintptr_t)CPG_CLKON_CM33, (uintptr_t)CPG_CLKMON_CM33, 0x00030000,
	  CPG_T_CLK },
	{ /* MHU */
	  (uintptr_t)CPG_CLKON_MHU, (uintptr_t)CPG_CLKMON_MHU, 0x00010000,
	  CPG_T_CLK },
	{ /* DMAC */
	  (uintptr_t)CPG_CLKON_DAMC_REG, (uintptr_t)CPG_CLKMON_DAMC_REG,
	  0x00030003, CPG_T_CLK },
	{ /* OSTM */
	  (uintptr_t)CPG_CLKON_OSTM, (uintptr_t)CPG_CLKMON_OSTM, 0x00060000,
	  CPG_T_CLK },
	{ /* MTU */
	  (uintptr_t)CPG_CLKON_MTU, (uintptr_t)CPG_CLKMON_MTU, 0x00010000,
	  CPG_T_CLK },
	{ /* POE3 */
	  (uintptr_t)CPG_CLKON_POE3, (uintptr_t)CPG_CLKMON_POE3, 0x00010000,
	  CPG_T_CLK },
	{ /* WDT */
	  (uintptr_t)CPG_CLKON_WDT, (uintptr_t)CPG_CLKMON_WDT, 0x00300000,
	  CPG_T_CLK },
#if USE_SDRAM
	{ /* DDR */
	  (uintptr_t)CPG_CLKON_DDR, (uintptr_t)CPG_CLKMON_DDR, 0x00030000,
	  CPG_T_CLK },
#else
	{ /* DDR */
	  (uintptr_t)CPG_CLKON_DDR, (uintptr_t)CPG_CLKMON_DDR, 0x00030003,
	  CPG_T_CLK },
#endif
	{ /* SDHI */
	  (uintptr_t)CPG_CLKON_SDHI, (uintptr_t)CPG_CLKMON_SDHI,
#if RZA3M
	  0x000f0000,
#else
	  0x00ff0000,
	  ...
	  CPG_T_CLK },
	{ /* Image Scaling Unit */
	  (uintptr_t)CPG_CLKON_ISU, (uintptr_t)CPG_CLKMON_ISU, 0x00030000,
	  CPG_T_CLK },
	{ /* Camera Data Receive Unit */
	  (uintptr_t)CPG_CLKON_CRU, (uintptr_t)CPG_CLKMON_CRU, 0x001f0000,
	  CPG_T_CLK },
	{ /* LCDC */
	  (uintptr_t)CPG_CLKON_LCDC, (uintptr_t)CPG_CLKMON_LCDC, 0x00030000,
	  CPG_T_CLK },
	{ /* Serial Sound Interface */
	  (uintptr_t)CPG_CLKON_SSI, (uintptr_t)CPG_CLKMON_SSI, 0x00ff0000,
	  CPG_T_CLK },
	{ /* Sampling Rate Converter */
	  (uintptr_t)CPG_CLKON_SRC, (uintptr_t)CPG_CLKMON_SRC, 0x00010000,
	  CPG_T_CLK },
	{ /* USB2.0 */
	  (uintptr_t)CPG_CLKON_USB, (uintptr_t)CPG_CLKMON_USB, 0x000f0000,
	  CPG_T_CLK },
	{ /* ETHER */
	  (uintptr_t)CPG_CLKON_ETH, (uintptr_t)CPG_CLKMON_ETH, 0x00030000,
	  CPG_T_CLK },
	{ /* I2C */
	  (uintptr_t)CPG_CLKON_I2C, (uintptr_t)CPG_CLKMON_I2C, 0x000f0000,
	  CPG_T_CLK },
	{ /* SCIF */
	  (uintptr_t)CPG_CLKON_SCIF, (uintptr_t)CPG_CLKMON_SCIF, 0x001f0001,
	  CPG_T_CLK },
	{ /* SCI */
	  (uintptr_t)CPG_CLKON_SCI, (uintptr_t)CPG_CLKMON_SCI, 0x00030000,
	  CPG_T_CLK },
	{ /* IrDA */
	  (uintptr_t)CPG_CLKON_IRDA, (uintptr_t)CPG_CLKMON_IRDA, 0x00010000,
	  CPG_T_CLK },
	{ /* SPI */
	  (uintptr_t)CPG_CLKON_RSPI, (uintptr_t)CPG_CLKMON_RSPI, 0x00070000,
	  CPG_T_CLK },
	{ /* CAN */
	  (uintptr_t)CPG_CLKON_CANFD, (uintptr_t)CPG_CLKMON_CANFD, 0x00010000,
	  CPG_T_CLK },
	{ /* GPIO */
	  (uintptr_t)CPG_CLKON_GPIO, (uintptr_t)CPG_CLKMON_GPIO, 0x00010001,
	  CPG_T_CLK },
	{ /* ADC */
	  (uintptr_t)CPG_CLKON_ADC, (uintptr_t)CPG_CLKMON_ADC, 0x00030000,
	  CPG_T_CLK },
	{ /* Thermal Sensor Unit */
	  (uintptr_t)CPG_CLKON_TSU, (uintptr_t)CPG_CLKMON_TSU, 0x00010000,
	  CPG_T_CLK }
};

static CPG_SETUP_DATA cpg_reset_tbl[] = {
	{ /* CM33 */
	  (uintptr_t)CPG_RST_CM33, (uintptr_t)CPG_RSTMON_CM33, 0x00070000,
	  CPG_T_RST },
	{ /* MHU */
	  (uintptr_t)CPG_RST_MHU, (uintptr_t)CPG_RSTMON_MHU, 0x00010000,
	  CPG_T_RST },
	{ /* DMAC */
	  (uintptr_t)CPG_RST_DMAC, (uintptr_t)CPG_RSTMON_DMAC, 0x00030003,
	  CPG_T_RST },
	{ /* OSTM */
	  (uintptr_t)CPG_RST_OSTM, (uintptr_t)CPG_RSTMON_OSTM, 0x00060000,
	  CPG_T_RST },
	{ /* MTU */
	  (uintptr_t)CPG_RST_MTU, (uintptr_t)CPG_RSTMON_MTU, 0x00010000,
	  CPG_T_RST },
	{ /* POE3 */
	  (uintptr_t)CPG_RST_POE3, (uintptr_t)CPG_RSTMON_POE3, 0x00010000,
	  CPG_T_RST },
	{ /* WDT */
	  (uintptr_t)CPG_RST_WDT, (uintptr_t)CPG_RSTMON_WDT, 0x00040000,
	  CPG_T_RST },
#if USE_SDRAM
	{ /* DDR */
	  (uintptr_t)CPG_RST_DDR, (uintptr_t)CPG_RSTMON_DDR, 0x007F0000,
	  CPG_T_RST },
#else
	{ /* DDR */
	  (uintptr_t)CPG_RST_DDR, (uintptr_t)CPG_RSTMON_DDR, 0x007F007F,
	  CPG_T_RST },
#endif
	{ /* SDHI */
	  (uintptr_t)CPG_RST_SDHI, (uintptr_t)CPG_RSTMON_SDHI,
#if RZA3M
	  0x00010000,
#else
	  0x00030000,
	  ...
	  CPG_T_RST },
	{ /* Image Scaling Unit */
	  (uintptr_t)CPG_RST_ISU, (uintptr_t)CPG_RSTMON_ISU, 0x00030000,
	  CPG_T_RST },
	{ /* Camera Data Receive Unit */
	  (uintptr_t)CPG_RST_CRU, (uintptr_t)CPG_RSTMON_CRU, 0x00070000,
	  CPG_T_RST },
	{ /* LCDC */
	  (uintptr_t)CPG_RST_LCDC, (uintptr_t)CPG_RSTMON_LCDC, 0x00010000,
	  CPG_T_RST },
	{ /* Serial Sound Interface */
	  (uintptr_t)CPG_RST_SSIF, (uintptr_t)CPG_RSTMON_SSIF, 0x000f0000,
	  CPG_T_RST },
	{ /* Sampling Rate Converter */
	  (uintptr_t)CPG_RST_SRC, (uintptr_t)CPG_RSTMON_SRC, 0x00010000,
	  CPG_T_RST },
	{ /* USB2.0 */
	  (uintptr_t)CPG_RST_USB, (uintptr_t)CPG_RSTMON_USB, 0x000f0000,
	  CPG_T_RST },
	{ /* ETHER */
	  (uintptr_t)CPG_RST_ETH, (uintptr_t)CPG_RSTMON_ETH, 0x00030000,
	  CPG_T_RST },
	{ /* I2C */
	  (uintptr_t)CPG_RST_I2C, (uintptr_t)CPG_RSTMON_I2C, 0x000f0000,
	  CPG_T_RST },
	{ /* SCIF */
	  (uintptr_t)CPG_RST_SCIF, (uintptr_t)CPG_RSTMON_SCIF, 0x001f0001,
	  CPG_T_RST },
	{ /* SCI */
	  (uintptr_t)CPG_RST_SCI, (uintptr_t)CPG_RSTMON_SCI, 0x00030000,
	  CPG_T_RST },
	{ /* IrDA */
	  (uintptr_t)CPG_RST_IRDA, (uintptr_t)CPG_RSTMON_IRDA, 0x00010000,
	  CPG_T_RST },
	{ /* SPI */
	  (uintptr_t)CPG_RST_RSPI, (uintptr_t)CPG_RSTMON_RSPI, 0x00070000,
	  CPG_T_RST },
	{ /* CAN */
	  (uintptr_t)CPG_RST_CANFD, (uintptr_t)CPG_RSTMON_CANFD, 0x00030000,
	  CPG_T_RST },
	{ /* GPIO */
	  (uintptr_t)CPG_RST_GPIO, (uintptr_t)CPG_RSTMON_GPIO, 0x00070007,
	  CPG_T_RST },
	{ /* ADC */
	  (uintptr_t)CPG_RST_ADC, (uintptr_t)CPG_RSTMON_ADC, 0x00030000,
	  CPG_T_RST },
	{ /* Thermal Sensor Unit */
	  (uintptr_t)CPG_RST_TSU, (uintptr_t)CPG_RSTMON_TSU, 0x00010000,
	  CPG_T_RST },
};
...
static CPG_REG_SETTING cpg_sel_pll1_on_off[] = { { (uintptr_t)CPG_CLKON_CA55,
						   0x00010001 } };
...
static CPG_REG_SETTING cpg_sel_pll5_3_on_off[] = { { (uintptr_t)CPG_CLKON_LCDC,
						     0x00020002 } };

static CPG_REG_SETTING cpg_sel_pll5_4_on_off[] = { { (uintptr_t)CPG_CLKON_LCDC,
						     0x00020002 } };
