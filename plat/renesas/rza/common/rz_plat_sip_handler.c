...
#define RZ_OTP_BASE_DEVID (PLAT_OTP_BASE + 0x1178)
#define RZ_OTP_BASE_CHIPID (PLAT_OTP_BASE + 0x1140)
...
static uintptr_t rz_otp_handler_chipid(void *handle, u_register_t x1,
				       u_register_t flags)
{
	uint32_t chipid[4];
