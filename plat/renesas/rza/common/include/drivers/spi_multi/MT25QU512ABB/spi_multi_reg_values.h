...
#define SPIM_PHYCNT_SET_VALUE                                               \
	(PHYCNT_DEF_DATA | PHYCNT_PHYMEM_SDR_MODE | PHYCNT_WBUF_NOT_USED |  \
	 PHYCNT_WBUF2_NOT_USED | PHYCNT_CKSEL_SLOW | PHYCNT_HS_OTHER_MODE | \
	 PHYCNT_OCT_OTHER_MODE | PHYCNT_EXDS_NOT_USED |                     \
	 PHYCNT_OCTA_HYPER_FLASH | PHYCNT_ALT_ALIGN_NOT_SUPPORTED |         \
	 PHYCNT_CAL_NOT_PERFOMED)
#define SPIM_PHYCNT_SDR_TIM_ADJ_SET_VALUE \
	(SPIM_PHYCNT_SET_VALUE | PHYCNT_CKSEL_FAST)

/* Read timing setting */
#define SPIM_PHYOFFSET1_SET_VALUE \
	(PHYOFFSET1_DEF_DATA | PHYOFFSET1_DDRTMG_SPIDRE_0)
#define SPIM_PHYOFFSET2_SET_VALUE \
	(PHYOFFSET2_DEF_DATA | PHYOFFSET2_OCTTMG_HYPER_FLASH)

/* Set the QSPIn_SSL setting value */
#define SPIM_CMNCR_EXTREAD_SET_VALUE                                          \
	(CMNCR_IO0FV_OUT_PREV | CMNCR_IO2FV_OUT_PREV | CMNCR_IO3FV_OUT_PREV | \
	 CMNCR_MOIIO0_OUT1 | CMNCR_MOIIO1_OUT1 | CMNCR_MOIIO2_OUT1 |          \
	 CMNCR_MOIIO3_OUT1 | CMNCR_DEF_DATA | CMNCR_MD_EXT_READ)

#define SPIM_CMNCR_MANUAL_SET_VALUE                                           \
	(CMNCR_IO0FV_OUT_PREV | CMNCR_IO2FV_OUT_PREV | CMNCR_IO3FV_OUT_PREV | \
	 CMNCR_MOIIO0_OUT1 | CMNCR_MOIIO1_OUT1 | CMNCR_MOIIO2_OUT1 |          \
	 CMNCR_MOIIO3_OUT1 | CMNCR_DEF_DATA | CMNCR_MD_MANUAL)
/* Set SSL delay setting value */
#define SPIM_SSLDR_SET_VALUE \
	(SSLDR_SCKDL_4_5 | SSLDR_SLNDL_4QSPIn | SSLDR_SPNDL_4QSPIn)
...
#define SPIM_DRENR_SET_VALUE                                              \
	(DRENR_CDB_1BIT | DRENR_OCDB_1BIT | SET_DRENR_ADB_VALUE |         \
...
#define SPIM_DRDRENR_SET_VALUE                                       \
	(DRDRENR_DRDRE_SDR | DRDRENR_OPDRE_SDR | DRDRENR_ADDRE_SDR | \
	 DRDRENR_HYPE_SPI)
