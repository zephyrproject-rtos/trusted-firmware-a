...
#define RZA_MMU_ATTR_NON_CACHEABLE \
...
#define RZA_MMU_ATTR_IWBWA_OWBWA_NTR \
	MAKE_MAIR_NORMAL_MEMORY(MAIR_NORM_WB_NTR_RWA, MAIR_NORM_WB_NTR_RWA)

#define RZA_MMU_ATTR_FIELD_WIDTH		(8)
#define RZA_MMU_MAIR_ATTR_SET(attr, index) \
	((attr) << ((index) * RZA_MMU_ATTR_FIELD_WIDTH))
...
#define RZA_MMU_ATTRIBUTE_NORMAL_CACHEABLE                              \
	(RZA_MMU_DESC_AF | RZA_MMU_DESC_SH_IS | RZA_MMU_DESC_AP_RW_RW | \
	 RZA_MMU_DESC_MAIR_INDEX_0)
#define RZA_MMU_ATTRIBUTE_NORMAL_UNCACHE                                \
	(RZA_MMU_DESC_AF | RZA_MMU_DESC_SH_IS | RZA_MMU_DESC_AP_RW_RW | \
	 RZA_MMU_DESC_MAIR_INDEX_2)
#define RZA_MMU_ATTRIBUTE_DEVICE                                        \
	(RZA_MMU_DESC_AF | RZA_MMU_DESC_SH_IS | RZA_MMU_DESC_AP_RW_RW | \
