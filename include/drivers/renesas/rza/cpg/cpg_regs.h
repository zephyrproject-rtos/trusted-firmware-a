...
#define CPG_CLUSTER_PCHMON	 (CPG_BASE + 0x0B30) /* CA55 Cluster Power Status Monitor */
#define CPG_CLUSTER_PCHCTL	 (CPG_BASE + 0x0B34) /* CA55 Cluster Power Status Control */
#define CPG_CORE0_PCHMON	 (CPG_BASE + 0x0B38) /* CA55 Core0 Power Status Monitor */
#define CPG_CORE0_PCHCTL	 (CPG_BASE + 0x0B3C) /* CA55 Core0 Power Status Control */
#define CPG_CORE1_PCHMON	 (CPG_BASE + 0x0B40) /* CA55 Core1 Power Status Monitor */
#define CPG_CORE1_PCHCTL	 (CPG_BASE + 0x0B44) /* CA55 Core1 Power Status Control */
#define CPG_BUS_ACPU_MSTOP	 (CPG_BASE + 0x0B60) /* MSTOP register BUS_ACPU */
#define CPG_BUS_MCPU1_MSTOP	 (CPG_BASE + 0x0B64) /* MSTOP register BUS_MCPU1 */
#define CPG_BUS_MCPU2_MSTOP	 (CPG_BASE + 0x0B68) /* MSTOP register BUS_MCPU2 */
#define CPG_BUS_PERI_COM_MSTOP	 (CPG_BASE + 0x0B6C) /* MSTOP register BUS_PERI_COM */
#define CPG_BUS_PERI_CPU_MSTOP	 (CPG_BASE + 0x0B70) /* MSTOP register BUS_PERI_CPU */
#define CPG_BUS_PERI_DDR_MSTOP	 (CPG_BASE + 0x0B74) /* MSTOP register BUS_PERI_DDR */
#define CPG_BUS_PERI_VIDEO_MSTOP (CPG_BASE + 0x0B78) /* MSTOP register BUS_PERI_VIDEO */
#define CPG_BUS_REG0_MSTOP	 (CPG_BASE + 0x0B7C) /* MSTOP register BUS_REG0 */
#define CPG_BUS_REG1_MSTOP	 (CPG_BASE + 0x0B80) /* MSTOP register BUS_REG1 */
#define CPG_BUS_TZCDDR_MSTOP	 (CPG_BASE + 0x0B84) /* MSTOP register BUS_TZCDDR */
#define CPG_MHU_MSTOP		 (CPG_BASE + 0x0B88) /* MSTOP register MHU */
#define CPG_BUS_PERI_STP_MSTOP	 (CPG_BASE + 0x0B8C) /* MSTOP register BUS_PERI_STP */
