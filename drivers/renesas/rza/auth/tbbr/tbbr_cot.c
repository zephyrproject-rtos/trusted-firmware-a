...
static auth_param_type_desc_t key_cert =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_RAW_DATA, 0);
static auth_param_type_desc_t content_cert =
	AUTH_PARAM_TYPE_DESC(AUTH_PARAM_RAW_DATA, 0);
...
static const auth_img_desc_t soc_fw_key_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]) {
			[0] = { .type_desc = &key_cert,
				.data = { .ptr = (void *)soc_fw_key_cert_buf,
...
static const auth_img_desc_t soc_fw_content_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]) {
			[0] = { .type_desc = &content_cert,
				.data = { .ptr = (void *)soc_fw_content_cert_buf,
					  .len = (unsigned int)
						  CONTENT_CERT_LEN } } }
};
...
static const auth_img_desc_t bl31_image = {
	...
	.img_auth_methods =
		(const auth_method_desc_t[AUTH_METHOD_NUM]) {
			[0] = { .type = AUTH_METHOD_SBLIB,
				.param.sblib = { .data = &raw_data,
						 .key_cert = &key_cert,
						 .content_cert =
							 &content_cert } } }
};
...
static const auth_img_desc_t trusted_os_fw_key_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]) {
			[0] = { .type_desc = &key_cert,
				.data = { .ptr = (void *)tos_fw_key_cert_buf,
					  .len = (unsigned int)KEY_CERT_LEN } } }
};
...
static const auth_img_desc_t trusted_os_fw_content_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]) {
			[0] = { .type_desc = &content_cert,
				.data = { .ptr = (void *)tos_fw_content_cert_buf,
					  .len = (unsigned int)
						  CONTENT_CERT_LEN } } }
};
...
static const auth_img_desc_t non_trusted_fw_key_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]) {
			[0] = { .type_desc = &key_cert,
				.data = { .ptr = (void *)nt_fw_key_cert_buf,
					  .len = (unsigned int)KEY_CERT_LEN } } }
};
...
static const auth_img_desc_t non_trusted_fw_content_cert = {
	...
	.authenticated_data =
		(const auth_param_desc_t[COT_MAX_VERIFIED_PARAMS]) {
			[0] = { .type_desc = &content_cert,
				.data = { .ptr = (void *)nt_fw_content_cert_buf,
					  .len = (unsigned int)
						  CONTENT_CERT_LEN } } }
};
