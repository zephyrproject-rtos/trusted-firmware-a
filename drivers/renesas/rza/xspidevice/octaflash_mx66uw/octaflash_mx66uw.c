...
/* Flash Commands */
/* Write Enable (SPI) */
static const xspi_op_t op_write_enable_spi = { .form = SPI_FORM_1_1_1,
					       .op = 0x06,
					       .op_size = 1,
					       .op_is_ddr = false,
					       .address = 0,
...
/* Write Enable (DOPI) */
static const xspi_op_t op_write_enable_dopi = { .form = SPI_FORM_8_8_8,
						.op = 0x06F9,
						.op_size = 2,
						.op_is_ddr = true,
						.address = 0,
...
static const xspi_op_t op_read_status_spi = { .form = SPI_FORM_1_1_1,
					      .op = 0x05,
					      .op_size = 1,
					      .op_is_ddr = false,
					      .address = 0,
...
static const xspi_op_t op_read_status_dopi = { .form = SPI_FORM_8_8_8,
					       .op = 0x05FA,
					       .op_size = 2,
					       .op_is_ddr = true,
					       .address = 0,
...
static const xspi_op_t op_write_config2_spi = { .form = SPI_FORM_1_1_1,
						.op = 0x72,
						.op_size = 1,
						.op_is_ddr = false,
						.address = 0,
...
static const xspi_op_t rop = { .form = SPI_FORM_8_8_8,
			       .op = 0xee11,
			       .op_size = 2,
			       .op_is_ddr = true,
			       .address = 0,
...
static const xspi_op_t op_page_program_dopi = { .form = SPI_FORM_8_8_8,
						.op = 0x12ED,
						.op_size = 2,
						.op_is_ddr = true,
						.address = 0,
...
/* Erase 4k (DOPI) */
static const xspi_op_t op_erase_4k_dopi = { .form = SPI_FORM_8_8_8,
					    .op = 0x21DE,
					    .op_size = 2,
					    .op_is_ddr = true,
					    .address = 0,
...
/* Erase 64k (DOPI) */
static const xspi_op_t op_erase_64k_dopi = { .form = SPI_FORM_8_8_8,
					     .op = 0xDC23,
					     .op_size = 2,
					     .op_is_ddr = true,
					     .address = 0,
...
static int __unused flash_read_status_register_spi(octaflash_mx66uw_ctrl_t *myctrl)
{
	int result;
	const xspi_instance_t *xspi = myctrl->xspi;
...
static int flash_write_config_register2_spi(octaflash_mx66uw_ctrl_t *myctrl,
		       ...
		       size_t address, size_t length)
{
	...
	if (RZ_XSPIFLASH_DISABLE_WRITE) {
		...
		assert(ctrl);
		octaflash_mx66uw_ctrl_t *myctrl =
			(octaflash_mx66uw_ctrl_t *)ctrl;
		const xspi_instance_t *xspi = myctrl->xspi;
