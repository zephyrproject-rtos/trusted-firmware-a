...
static int octa_exec_op(xspi_ctrl_t *const ctrl, xspi_op_t const *const op,
			bool is_write);
static int octa_configure_xip(xspi_ctrl_t *const ctrl,
...
static const uint32_t init_octa_dcr_value;
static const uint32_t init_octa_dar_value;
static const uint32_t init_octa_dcsr_value =
	0 | 0u << OCTA_DCSR_ACDA_POS | 0u << OCTA_DCSR_DOPI_POS |
	0u << OCTA_DCSR_ADLEN_POS | 0u << OCTA_DCSR_DAOR_POS |
	0u << OCTA_DCSR_CMDLEN_POS | 0u << OCTA_DCSR_ACDV_POS |
	0u << OCTA_DCSR_DMLEN_POS | 0u << OCTA_DCSR_DALEN_POS;
static const uint32_t init_octa_dsr0_value =
	0 | OCTA_DSR_TYP_NONE >> OCTA_DSR0_DV0TYP_POS |
	0u << OCTA_DSR0_DV0SZ_POS;
static const uint32_t init_octa_dsr1_value =
	0 | OCTA_DSR_TYP_NONE >> OCTA_DSR1_DV1TYP_POS |
	0u << OCTA_DSR1_DV1SZ_POS;
static const uint32_t init_octa_mdtr_value =
	0 | 6u << OCTA_MDTR_DQSEDOPI_POS | 0x50u << OCTA_MDTR_DV1DEL_POS |
	9u << OCTA_MDTR_DQSESOPI_POS | 4u << OCTA_MDTR_DQSERAM_POS |
	0x50u << OCTA_MDTR_DV0DEL_POS;
static const uint32_t init_octa_actr_value = 268435456;
static const uint32_t init_octa_acar0_value;
static const uint32_t init_octa_acar1_value;
static const uint32_t init_octa_drcstr_value =
	0 | 0u << OCTA_DRCSTR_DVRDLO1_POS | 0u << OCTA_DRCSTR_DVRDHI1_POS |
	0u << OCTA_DRCSTR_DVRDCMD1_POS |
#if !RZA3
	0u << OCTA_DRCSTR_CTR1_POS | 127u << OCTA_DRCSTR_CTRW1_POS |
#endif
	0u << OCTA_DRCSTR_DVRDLO0_POS | 0u << OCTA_DRCSTR_DVRDHI0_POS |
	0u << OCTA_DRCSTR_DVRDCMD0_POS | 1u << OCTA_DRCSTR_CTR0_POS |
	127u << OCTA_DRCSTR_CTRW0_POS;
static const uint32_t init_octa_dwcstr_value =
	0 | 0u << OCTA_DWCSTR_DVWLO1_POS | 0u << OCTA_DWCSTR_DVWHI1_POS |
	0u << OCTA_DWCSTR_DVWCMD1_POS | 0u << OCTA_DWCSTR_DVWLO0_POS |
	0u << OCTA_DWCSTR_DVWHI0_POS | 0u << OCTA_DWCSTR_DVWCMD0_POS;
static const uint32_t init_octa_dcstr_value = 0 | 0u << OCTA_DCSTR_DVSELLO_POS |
					      0u << OCTA_DCSTR_DVSELHI_POS |
					      0u << OCTA_DCSTR_DVSELCMD_POS;
static const uint32_t init_octa_cdsr_value =
	0 | 1u << OCTA_CDSR_DLFT_POS | 0u << OCTA_CDSR_ACMEME1_POS |
	0u << OCTA_CDSR_ACMEME0_POS | 0u << OCTA_CDSR_DV1PC_POS |
	0u << OCTA_CDSR_DV0PC_POS |
	OCTA_CDSR_DVTTYP_SPI << OCTA_CDSR_DV1TTYP_POS |
	OCTA_CDSR_DVTTYP_SPI << OCTA_CDSR_DV0TTYP_POS;
static const uint32_t init_octa_mdlr_value =
	0 | 0u << OCTA_MDLR_DV1WDL_POS | 0u << OCTA_MDLR_DV1RDL_POS |
	0u << OCTA_MDLR_DV0WDL_POS | 0u << OCTA_MDLR_DV0RDL_POS;
static const uint32_t init_octa_mrwcr0_value =
	0 | 0u << OCTA_MRWCR0_D0MWCMD1_POS | 0u << OCTA_MRWCR0_D0MWCMD0_POS |
	0u << OCTA_MRWCR0_D0MRCMD1_POS | 0u << OCTA_MRWCR0_D0MRCMD0_POS;
static const uint32_t init_octa_mrwcr1_value =
	0 | 0u << OCTA_MRWCR1_D1MWCMD1_POS | 0u << OCTA_MRWCR1_D1MWCMD0_POS |
	0u << OCTA_MRWCR1_D1MRCMD1_POS | 0u << OCTA_MRWCR1_D1MRCMD0_POS;
static const uint32_t init_octa_mrwcsr_value =
	0 | 0u << OCTA_MRWCSR_MWO1_POS | 0u << OCTA_MRWCSR_MWCL1_POS |
	0u << OCTA_MRWCSR_MWAL1_POS | 0u << OCTA_MRWCSR_MRO1_POS |
	0u << OCTA_MRWCSR_MRCL1_POS | 0u << OCTA_MRWCSR_MRAL1_POS |
	0u << OCTA_MRWCSR_MWO0_POS | 0u << OCTA_MRWCSR_MWCL0_POS |
	0u << OCTA_MRWCSR_MWAL0_POS | 0u << OCTA_MRWCSR_MRO0_POS |
	0u << OCTA_MRWCSR_MRCL0_POS | 0u << OCTA_MRWCSR_MRAL0_POS;
...
static void select_octa(octa_ctrl_t *myctrl, xspi_cfg_t const *const cfg)
{
	...
	if (RZ_XSPI_EXCLUSIVE_SELECTOR) {
		...
		ipcont_spi_octa |= IPCONT_SEL_SPI_OCTA_OCTA
...
static int octa_open(xspi_ctrl_t *ctrl, xspi_cfg_t const *const cfg)
{
	...
	if (myctrl->channel) {
		...
		uint32_t ch1_calibration_offset =
			DEFAULT_CH1_CALIBRATION_OFFSET;
	...
	if (!initialised[myctrl->channel]) {
		...
		if (myctrl->channel) {
			...
			if (dsr <= 8 * 1024 * 1024)
				aer = OCTA_AER_LE64MB;
			else if (dsr <= 16 * 1024 * 1024)
				aer = OCTA_AER_128MB;
			else if (dsr <= 32 * 1024 * 1024)
				aer = OCTA_AER_256MB;
			else
				aer = OCTA_AER_512MB;
...
{
	if (!initialised[channel])
		return true; /* Ignore for empty channel */
	if (!is_dopi)
		return true; /* Ignore or SPI/SOPI channel */
	if (!is_calibrated[channel])
		return true; /* Ignore if failed the manual calibration */
...
static void octa_set_acmode(uint32_t *cdsr)
{
	if (post_init_done) {
		...
		is_dopi = (*cdsr & OCTA_CDSR_DV0TTYP) ==
			  (OCTA_CDSR_DVTTYP_DOPI << OCTA_CDSR_DV0TTYP_POS);
		...
		is_dopi = (*cdsr & OCTA_CDSR_DV1TTYP) ==
			  (OCTA_CDSR_DVTTYP_DOPI << OCTA_CDSR_DV1TTYP_POS);
		flag_1 = octa_check_acmode_ready(acmeme1, is_dopi, 1);

		/* mask old value */
		*cdsr &= ~OCTA_CDSR_ACMODE;

		/* When both CH0/CH1 are ready for enabling ACMODE and */
		/* either ACMEME0 or ACMEME1 is enabled */
		if (flag_0 && flag_1 && (acmeme0 || acmeme1)) {
			*cdsr |= OCTA_CDSR_ACMODE_ENABLE
				 << OCTA_CDSR_ACMODE_POS;
		}
	}
}
...
{
	if (!(op->op_is_ddr == op->address_is_ddr))
		return -1;
	if (!op->op_is_ddr && !op->address_is_ddr && op->transfer_is_ddr)
		return -1;
	return 0;
}

static int octa_test_form(octa_ctrl_t const *const myctrl,
			  xspi_op_t const *const op)
{
	if (!(myctrl->device_type != OCTA_DSR_TYP_NONE))
		return -1;
	if (!((myctrl->device_type == OCTA_DSR_TYP_FLASH &&
	       (op->form == SPI_FORM_8_8_8 ||
		(op->form == SPI_FORM_1_1_1 && !op->op_is_ddr &&
		 !op->address_is_ddr && !op->transfer_is_ddr))) ||
	      (myctrl->device_type == OCTA_DSR_TYP_RAM &&
	       op->form == SPI_FORM_8_8_8 && op->op_is_ddr &&
	       op->address_is_ddr && op->transfer_is_ddr)))
		return -1;
	return 0;
}
			...
			bool is_write)
{
	...
	assert(op->transfer_size == 0 || op->transfer_size == 1 ||
	       op->transfer_size == 2 || op->transfer_size == 4 ||
	       (op->transfer_size == 3 && op->transfer_is_ddr == false &&
		is_write == false));
	...
	case SPI_FORM_8_8_8:
		if (op->op_is_ddr) {
			...
			if (myctrl->device_type == OCTA_DSR_TYP_RAM) {
				...
				if (enable_counter > 15)
					enable_counter = 15;
				mdtr_clear |= OCTA_MDTR_DQSERAM;
				mdtr_set |= enable_counter
					    << OCTA_MDTR_DQSERAM_POS;
			} else {
				transfer_type = OCTA_CDSR_DVTTYP_DOPI;
	...
	dcsr_set |= (op->transfer_size == 3 ? 4u : op->transfer_size)
		    << OCTA_DCSR_DALEN_POS;
	...
	if (is_write) {
		...
		case 0:
			...
			break;
		case 1:
			mmio_write_8(myctrl->reg_base + OCTA_CWDR,
				     *(uint8_t *)op->transfer_buffer);
			break;
		case 2:
			mmio_write_16(myctrl->reg_base + OCTA_CWDR,
				      *(uint16_t *)op->transfer_buffer);
			break;
		case 4:
			mmio_write_32(myctrl->reg_base + OCTA_CWDR,
				      *(uint32_t *)op->transfer_buffer);
			break;
		}
	} else {
		...
		case 1:
			*(uint8_t *)op->transfer_buffer =
				mmio_read_8(myctrl->reg_base + OCTA_CRR);
			break;
		case 2:
			*(uint16_t *)op->transfer_buffer =
				mmio_read_16(myctrl->reg_base + OCTA_CRR);
			break;
		case 3: {
			uint32_t tmp =
				mmio_read_32(myctrl->reg_base + OCTA_CRR);
...
static void octa_configure_xip_ch1(octa_ctrl_t *const myctrl,
				   xspi_op_t const *const rop,
				   xspi_op_t const *const wop)
{
	...
	if (rop) {
		...
		drcstr_clear |= OCTA_DRCSTR_DVRDLO1 | OCTA_DRCSTR_DVRDHI1 |
				OCTA_DRCSTR_DVRDCMD1;
		...
		mrwcsr_clear |= OCTA_MRWCSR_MRO1 | OCTA_MRWCSR_MRCL1 |
				OCTA_MRWCSR_MRAL1;
		if (rop->transfer_is_ddr &&
		    ~rop->transfer_flag & XSPI_FLAGS_SEQUENTIAL_DDR) {
		...
		mmio_clrsetbits_32(myctrl->reg_base + OCTA_DRCSTR, drcstr_clear,
				   drcstr_set);
	}
	if (wop) {
		...
		dwcstr_clear |= OCTA_DWCSTR_DVWLO1 | OCTA_DWCSTR_DVWHI1 |
				OCTA_DWCSTR_DVWCMD1;
		...
		mrwcsr_clear |= OCTA_MRWCSR_MWO1 | OCTA_MRWCSR_MWCL1 |
				OCTA_MRWCSR_MWAL1;
		if (wop->transfer_is_ddr &&
		    ~wop->transfer_flag & XSPI_FLAGS_SEQUENTIAL_DDR) {
		...
		mmio_clrsetbits_32(myctrl->reg_base + OCTA_DWCSTR, dwcstr_clear,
				   dwcstr_set);
	}
	mmio_clrsetbits_32(myctrl->reg_base + OCTA_MDLR, mdlr_clear, mdlr_set);
	mmio_clrsetbits_32(myctrl->reg_base + OCTA_MRWCR1, mrwcr_clear,
			   mrwcr_set);
	mmio_clrsetbits_32(myctrl->reg_base + OCTA_MRWCSR, mrwcsr_clear,
			   mrwcsr_set);
}

static void octa_configure_xip_ch0(octa_ctrl_t *const myctrl,
				   xspi_op_t const *const rop,
				   xspi_op_t const *const wop)
{
	uint32_t mdlr_clear, mdlr_set;
	...
	if (rop) {
		...
		drcstr_clear = drcstr_set = 0;
		drcstr_clear |= OCTA_DRCSTR_DVRDLO0 | OCTA_DRCSTR_DVRDHI0 |
				OCTA_DRCSTR_DVRDCMD0;
		...
		mrwcsr_clear |= OCTA_MRWCSR_MRO0 | OCTA_MRWCSR_MRCL0 |
				OCTA_MRWCSR_MRAL0;
		if (rop->transfer_is_ddr &&
		    ~rop->transfer_flag & XSPI_FLAGS_SEQUENTIAL_DDR) {
	...
	if (wop) {
		...
		dwcstr_clear = dwcstr_set = 0;
		dwcstr_clear |= OCTA_DWCSTR_DVWLO0 | OCTA_DWCSTR_DVWHI0 |
				OCTA_DWCSTR_DVWCMD0;
		...
		mrwcsr_clear |= OCTA_MRWCSR_MWO0 | OCTA_MRWCSR_MWCL0 |
				OCTA_MRWCSR_MWAL0;
		if (wop->transfer_is_ddr &&
		    ~wop->transfer_flag & XSPI_FLAGS_SEQUENTIAL_DDR) {
	...
	mmio_clrsetbits_32(myctrl->reg_base + OCTA_MDLR, mdlr_clear, mdlr_set);
	mmio_clrsetbits_32(myctrl->reg_base + OCTA_MRWCR0, mrwcr_clear,
			   mrwcr_set);
	mmio_clrsetbits_32(myctrl->reg_base + OCTA_MRWCSR, mrwcsr_clear,
			   mrwcsr_set);
}
			      ...
			      xspi_op_t const *const wop)
{
	...
	if (rop && wop) {
		...
		assert(rop->op_is_ddr == wop->op_is_ddr &&
		       rop->address_is_ddr == wop->address_is_ddr &&
		       rop->transfer_is_ddr == wop->transfer_is_ddr);
	}
		...
		if (op->op_is_ddr) {
			...
			if (myctrl->device_type == OCTA_DSR_TYP_RAM) {
				...
				if (myctrl->channel && !RZA3) {
					mmio_clrsetbits_32(myctrl->reg_base +
								   OCTA_DRCSTR,
							   OCTA_DRCSTR_CTR1, 0);
...
static int octa_manual_calibration_common(octa_ctrl_t *myctrl)
{
	...
	for (index = 0; index < DELAY_LEVELS; index++) {
		/* Set DQS delay value */
		mmio_write_32(myctrl->reg_base + OCTA_MDTR,
			      mdtr | (index * 256 / DELAY_LEVELS) << mdtr_pos);
	...
	if (ok_cnt > 3) {
		/* Set DQS delay value */
		uint32_t delay =
			(index_start + (ok_cnt >> 1)) * (256 / DELAY_LEVELS);
		mmio_write_32(myctrl->reg_base + OCTA_MDTR,
			      mdtr | delay << mdtr_pos);
		mmio_read_32(myctrl->reg_base + OCTA_MDTR);
		return 0;
...
static int octa_manual_calibration_ch0(octa_ctrl_t *myctrl)
{
	...
	uint32_t cdsr = mmio_read_32(myctrl->reg_base + OCTA_CDSR);
	uint32_t ch0_transfer_type = (cdsr & OCTA_CDSR_DV0TTYP) >>
				     OCTA_CDSR_DV0TTYP_POS;
	if (ch0_transfer_type != OCTA_CDSR_DVTTYP_DOPI)
		return 0;
	if (!is_prepared) {
		uint32_t dsr0 = mmio_read_32(myctrl->reg_base + OCTA_DSR0);
		uint32_t ch0_device_type = (dsr0 & OCTA_DSR0_DV0TYP) >>
					   OCTA_DSR0_DV0TYP_POS;
...
static int octa_manual_calibration_ch1(octa_ctrl_t *myctrl)
{
	...
	static bool is_prepared;
	uint32_t cdsr = mmio_read_32(myctrl->reg_base + OCTA_CDSR);
	uint32_t ch1_transfer_type = (cdsr & OCTA_CDSR_DV1TTYP) >>
				     OCTA_CDSR_DV1TTYP_POS;
	if (ch1_transfer_type != OCTA_CDSR_DVTTYP_DOPI)
		return 0;
	if (!is_prepared) {
		uint32_t dsr1 = mmio_read_32(myctrl->reg_base + OCTA_DSR1);
		uint32_t ch1_device_type = (dsr1 & OCTA_DSR1_DV1TYP) >>
					   OCTA_DSR1_DV1TYP_POS;
